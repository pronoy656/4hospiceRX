            ...
            <div className="max-w-7xl mx-auto text-center">
                ...
                <form className="max-w-[700px] mx-auto flex flex-col sm:flex-row items-center gap-4">
                    <input
                        ...
                        placeholder="Email*"
                        required
                        className="flex-1 w-full px-8 py-3 bg-white/90 backdrop-blur-sm border border-[#38B6FF]/30 rounded-[22px] text-[#033074] placeholder-[#94A3B8] font-semibold text-lg focus:outline-none focus:ring-4 focus:ring-[#38B6FF]/10 focus:border-[#38B6FF] transition-all shadow-sm"
                    />
                    <button className="w-full sm:w-auto px-12 py-3 bg-[#38B6FF] hover:bg-[#31a1e0] text-white font-black text-xl rounded-[22px] shadow-[0_15px_30px_-5px_rgba(56,182,255,0.4)] transition-all transform hover:translate-y-[-2px] active:scale-95">
                        Sign Up
                    </button>
                </form>
            </div>
