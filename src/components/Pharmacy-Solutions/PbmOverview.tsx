...
export default function PbmOverview() {
    return (
        <section className="py-24 px-6 relative bg-gradient-to-b from-white via-[#BAE6FD] to-[#BAEFFF]">
            <div className="max-w-[1240px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
                    {features.slice(0, 3).map((feature, i) => (
                        <div key={i} className="bg-white p-12 rounded-[3.5rem] border border-[#F1F5F9] flex flex-col items-center text-center group cursor-default hover:shadow-lg transition-all duration-500 hover:translate-y-[-5px]">
                ...
                <div className="flex justify-center">
                    <div className="max-w-[420px] w-full bg-white p-12 rounded-[3.5rem] border border-[#F1F5F9] flex flex-col items-center text-center group cursor-default hover:shadow-lg transition-all duration-500 hover:translate-y-[-5px]">
                        <div className="w-16 h-16 bg-[#E0F2FE] rounded-full flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
                            {features[3].icon}
                        </div>
                        <h3 className="text-xl font-bold text-[#013074] mb-4 leading-tight tracking-tight uppercase">
