...
export default function Toolspage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white via-[#BAEFFF]/50 to-white">
            ...
            <section className="relative bg-gradient-to-b from-[#003B73] to-[#005CAD] pt-28 pb-32 text-center text-white overflow-hidden">
                ...
                <div className="relative max-w-[1200px] mx-auto px-6 z-10 flex flex-col items-center">
                    ...
                    <h1 className="text-[56px] font-extrabold leading-tight mb-6 tracking-tight">Clinical Tools</h1>
                    <p className="text-white/80 text-lg max-w-2xl mx-auto leading-relaxed">
                        Hospice-specific decision support tools, alphabetized for quick access
                    </p>
                </div>

                {/* Curved bottom transition SVG - Crisp White Curve */}
            ...
            {/* Grid of Tools - Pulled into the Hero for more depth */}
            <div className="max-w-[1200px] mx-auto px-6 py-12 lg:py-20 -mt-8 lg:-mt-16 relative z-10">
                <div 
                    ref={gridRef}
